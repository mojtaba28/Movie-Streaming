...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.ViewHolder> {
    ...
    boolean isLimited;
    PopularMovieItemOnClick popularMovieItemOnClick;
    public PopularAdapter(Context context, List<MovieModel> list,boolean isLimited,PopularMovieItemOnClick popularMovieItemOnClick){
        this.context=context;
        this.list=list;
        this.isLimited=isLimited;
        this.popularMovieItemOnClick=popularMovieItemOnClick;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        PushDownAnim.setPushDownAnimTo(holder.itemView).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                popularMovieItemOnClick.onItemClick(model);
            }
        });
    }
    ...
    public interface PopularMovieItemOnClick{
